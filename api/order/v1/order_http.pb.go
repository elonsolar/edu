...
const OperationOrderDeleteOrder = "/order.v1.Order/DeleteOrder"
const OperationOrderGetOrder = "/order.v1.Order/GetOrder"
const OperationOrderListOrder = "/order.v1.Order/ListOrder"
const OperationOrderUpdateOrder = "/order.v1.Order/UpdateOrder"
...
func RegisterOrderHTTPServer(s *http.Server, srv OrderHTTPServer) {
	...
	r.PUT("/order/{id}", _Order_UpdateOrder0_HTTP_Handler(srv))
	r.DELETE("/order/{id}", _Order_DeleteOrder0_HTTP_Handler(srv))
	r.GET("/order", _Order_GetOrder0_HTTP_Handler(srv))
	r.GET("/order/page", _Order_ListOrder0_HTTP_Handler(srv))
}
