...
func IsMobileAlreadyExist(err error) bool {
	if err == nil {
		return false
	}
	e := errors.FromError(err)
	return e.Reason == ErrorReason_MOBILE_ALREADY_EXIST.String() && e.Code == 504
}

func ErrorMobileAlreadyExist(format string, args ...interface{}) *errors.Error {
	return errors.New(504, ErrorReason_MOBILE_ALREADY_EXIST.String(), fmt.Sprintf(format, args...))
}
